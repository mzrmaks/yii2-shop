...
class CatalogController extends \yii\web\Controller
{
    ...
    public function actionList($id = null)
    {
        ...
        $brands = Brands::find()->indexBy('id')->orderBy('id')->all();
        ...
        $productsTabQuery = Product::find();
        if ($id !== null && isset($categories[$id])) {
            $category = $categories[$id];
            $productsTabQuery->where(['category_id' => $this->getCategoryIds($categories, $id)])->limit(3);
        }
        $productsTabDataProvider = new ActiveDataProvider([
            'query' => $productsTabQuery,
            'totalCount' => 4,
            'pagination' => [
                'pageSize' => 4,
            ],
        ...
        $recommendedProductDataProvider = new ActiveDataProvider([
            'query' => $productsTabQuery,
            'totalCount' => 3,
            'pagination' => [
                'pageSize' => 3,
        ...
        return $this->render('list', [
            ...
            'productsTabDataProvider' => $productsTabDataProvider,
            'recommendedProductDataProvider' => $recommendedProductDataProvider,
            'brands' => $brands,
        ]);
    }
